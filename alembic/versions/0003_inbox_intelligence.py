...
def upgrade() -> None:
    ...
    op.add_column(
        "emails", sa.Column("sender_address", sa.String(length=320), server_default="", nullable=False)
    )
    ...
    op.add_column(
        "emails", sa.Column("category_source", sa.String(length=16), server_default="auto", nullable=False)
    )
    ...
    op.add_column(
        "emails", sa.Column("unsubscribe_one_click", sa.Boolean(), server_default="0", nullable=False)
    )
